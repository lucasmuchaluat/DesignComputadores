...
entity aula1Ativ1 is
    ...
    (
        ...
        entradaX, entradaY: in STD_LOGIC_VECTOR((larguraDados-1) downto 0);
...
architecture comportamento of aula1Ativ1 is
	 ...
	 signal cte7 : STD_LOGIC_VECTOR((larguraDados-1) downto 0) := cte7"0007"; -- 7
